...
def build_pdf():
    ...
    pdf_filename = os.path.join(scratch_dir, "instrucao_trabalho_clayton_5s.pdf")
    artifacts_pdf = os.path.join(brain_dir, "instrucao_trabalho_clayton_5s.pdf")
    ...
    if os.path.exists(logo_jpg_scratch):
        ...
        header_text = Paragraph(
            ...
            "<font color='#06b6d4' size='8'>PROGRAMA LEAN & QUALIDADE 5S</font><br/>"
    ...
    # 3. TEXTO OFICIAL SOLICITADO REVISADO (NOME CLAYTON + SEM CONSULTORIA)
    exaltation_text = """
    <b>Prezado Clayton,</b><br/><br/>
    É com imenso orgulho e confiança que a <b>IMPAK TTO Plásticos de Engenharia</b> convida você para a função estratégica de <b>AUDITOR VOLANTE / CORINGA 5S (GRUPO 2)</b>.<br/><br/>
    ...
    cred_data = [
        [Paragraph("<b>Usuário de Acesso:</b>", body_style), Paragraph("<font color='#0284c7'><b>clayton.auditor</b></font> (ou apenas <i>clayton</i>)", body_style)],
    ...
    # 5. AS 3 ATRIBUIÇÕES PRINCIPAIS DO CLAYTON
    ...
    signatures_data = [
        [
            Paragraph("_____________________________<br/><b>Clayton</b><br/><font size='7.5' color='#64748b'>Auditor Volante 5S (Grupo 2)</font>", ParagraphStyle('Sig1', parent=styles['Normal'], alignment=1)),
        ...
        [
            Paragraph("<br/><br/>_____________________________<br/><b>Alexandre Souza</b><br/><font size='7.5' color='#64748b'>Gerente de Projeto / Líder Mestre</font>", ParagraphStyle('Sig3', parent=styles['Normal'], alignment=1)),
    ...
    print("PDF RECOMPILADO PARA CLAYTON COM SUCESSO!")
